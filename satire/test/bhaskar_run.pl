...
# ------------------------------ Step 1 Converting judgments to QRELS (only needed for INST) -----------------------------
...
# ------------------------------ Step 2 Writing the T_per_query file (only needed for INST)  -----------------------------
...
$cmd = "../src/i.exe inputFileName=DINNER/tds.txt outputStem=../test/bhaskar numDocs=1842879 -lowScoreCutoff=1000";
