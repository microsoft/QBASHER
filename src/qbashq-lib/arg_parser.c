...
arg_t args[] = {
  ...
  /* 45 */{ "language", ASTRING, TRUE, 0, 0, "Any language specific processing will be done in this language, if supported.  Two-char language code. E.g. EN, DE, FR" },
  /* 46 */{ "use_substitutions", ABOOL, FALSE, 0, 0, "If TRUE, and there is a QBASH.substitution_rules file for the current language, substitutions will be applied to queries." },
