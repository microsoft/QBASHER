...
#define HAVE_64BIT_LONG_LONG 1  // David Hawking
#ifdef WIN64
typedef unsigned int u_int; // David Hawking
typedef unsigned long long u_int64_t; // David Hawking
#endif
...
#define HAVE_64BIT_LONG_LONG 1   // Inserted by David Hawking
